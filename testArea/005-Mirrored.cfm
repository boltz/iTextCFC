...
<a href="./bacon-Mirror.pdf">View PDF</a>
<br>
...
<!--- Set the path --->
<cfset fullPath = expandPath("./bacon-Mirror.pdf")>
...
<cfset pageSize = createObject("java", "com.itextpdf.text.Rectangle").init(standardSizes.A5)>
...
<cfset document.setMarginMirroring(true)>
